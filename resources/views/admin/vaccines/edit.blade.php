...
<div class="container-fluid">
    ...
    <div class="content-card">
        <div class="card-header">
            <h2 class="card-title">Alterar dados da vacina</h2>
        </div>
            ...
            <div class="row">
                    ...
                    <select name="animal_id" class="form-control" required>
                        @foreach($animals as $animal)
                            <option value="{{ $animal->id }}"
                                {{ old('animal_id', $vaccine->animal_id) == $animal->id ? 'selected' : '' }}>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input
                        ...
                        name="date"
                        class="form-control"
                        value="{{ old('date', $vaccine->date ? $vaccine->date->format('Y-m-d') : null) }}"
                        required
                    >
                    @error('date')
                        <div class="text-danger small">{{ $message }}</div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input
                        ...
                        name="veterinarian"
                        class="form-control"
                        value="{{ old('veterinarian', $vaccine->veterinarian) }}"
                    >
                    @error('veterinarian')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea
                        ...
                        class="form-control"
                        rows="3"
                    >{{ old('notes', $vaccine->notes) }}</textarea>
                    @error('notes')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
